<?php
// api/pacientes/seguros/debug-crear-temp.php
...
// Log inicial
error_log("=== DEBUG CREAR SEGURO TEMPORAL ===");
...
try {
    ...
    // Preparar INSERT con solo campos básicos
    $stmt = $conn->prepare("
    ...
    error_log("Ejecutando INSERT básico...");
    $stmt->execute();
    ...
    echo json_encode([
        "success" => true,
        "message" => "Seguro creado exitosamente (modo debug básico)",
        "id" => $seguro_id,
        "debug_info" => [
            "paciente" => $paciente,
