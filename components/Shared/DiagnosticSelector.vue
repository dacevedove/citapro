  ...
  <div class="diagnostic-selector-container">
    ...
    <div class="search-section">
      ...
      <div class="search-input-container">
        ...
        <div
          v-if="showDropdown && (searchResults.length > 0 || (searchQuery && searchResults.length === 0))"
...
// Importar datos CIE-10 directamente en el componente
let cie10Data = [];

// Carga dinámica del archivo JSON
async function loadCie10Data() {
  try {
    const response = await fetch('https://citas.salu.pro/data/cie10.json');
...
export default {
  ...
  methods: {
    ...
    async performSearch() {
      ...
      if (!this.fuse) {
        console.warn('Fuse.js no está inicializado. Verifique que diagnosticData esté cargado.');
        return;
      }
